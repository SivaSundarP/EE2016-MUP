...
; Interrupt2.asm
;
; Created: 18-09-2024 12:43:09 PM
; Author : Bhavesh
;
...
reset:
    ...
    ldi r16, (1<<pb1) ; make PB1 output (Red LED)
    out ddrb, r16     ; setting direction of PB1 to output

    ldi r16, (1<<pb0) ; make PB0 output (White LED)
    out ddrb, r16     ; setting direction of PB0 to output
    ...
    ldi r16, (1<<pb0) ; Turn on White LED
    out portb, r16
...
delay4:
    ...
    ; Restore state
    ldi r16, (1<<pb0) ; Turn on White LED again
    out portb, r16
